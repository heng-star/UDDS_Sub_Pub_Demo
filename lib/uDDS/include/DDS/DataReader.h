...
public:
	...
	//ReturnCode_t read_instance(UserData& data_values, SampleInfo& sample_info, long max_samples, InstanceHandle_t handle, SampleStateKind sample_states, ViewStateKind samole_states[], InstanceStateKind instance_states);
	...
	///* JDXCZ    从DataReader复制下一个之前未访问过的Data值 */
	//ReturnCode_t read_next_instance(Data data_values[], SampleInfo sample_info[], long max_samples, InstanceHandle_t previous_handle, SampleStateKind sample_states, ViewStateKind samole_states[], InstanceStateKind instance_states);
	...
	ReturnCode_t return_loan(UserData& data_values, SampleInfoSeq sample_infos);
